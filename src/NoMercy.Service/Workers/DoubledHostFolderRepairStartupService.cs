...
/// is put right. Runs on every start rather than behind a one-shot flag: the
/// sweep is one indexed query on a healthy database and stays a safety net if
/// the shape ever reappears.
/// </summary>
