...
export const WEB_FIXTURES: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-app-web', 'src', 'lib', 'plugin', 'fixtures.generated.ts',
);

export const CAST_FIXTURES: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-cast-player', 'src', 'lib', 'plugin', 'fixtures.generated.ts',
);

export const KMP_FIXTURES: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-app-kmp', 'shared', 'src', 'commonTest',
...
export const SINK_FIXTURES: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-app-web', 'tests', 'playwright', 'fixture', 'sink',
);

export const CAST_SINK_COMPONENTS: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-cast-player', 'src', 'lib', 'plugin', 'sinkComponents.generated.ts',
);

export const WEB_SINK_COMPONENTS: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-app-web', 'src', 'lib', 'plugin', 'sinkComponents.generated.ts',
);

export const KMP_SINK_FIXTURES: string = resolve(
  REPO_ROOT, 'apps', 'nomercy-app-kmp', 'shared-ui-compose', 'src', 'jvmTest', 'resources', 'plugin',
);
