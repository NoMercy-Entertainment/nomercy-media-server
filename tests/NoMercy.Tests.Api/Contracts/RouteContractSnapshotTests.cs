...
public class RouteContractSnapshotTests : IClassFixture<NoMercyApiFactory>
{
    ...
    [
        ...
        "DELETE api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/lan-devices/{deviceId} [PluginLanDevice.Destroy]",
        "DELETE api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/users/{userId:guid} [PluginUserData.Destroy]",
        ...
        "GET api/v{version:apiVersion}/dashboard/plugins/offline-mode [PluginOfflineBundle.Index]",
        "GET api/v{version:apiVersion}/dashboard/plugins/telemetry [PluginTelemetry.Index]",
        "GET api/v{version:apiVersion}/dashboard/plugins/developer-mode [Plugin.DeveloperMode]",
        "GET api/v{version:apiVersion}/dashboard/plugins/runtime-mode [Plugin.RuntimeMode]",
        "GET api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/capabilities [PluginCapability.Index]",
        "GET api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/quotas [PluginQuota.Index]",
        "GET api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/lan-devices [PluginLanDevice.Index]",
        "GET api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/users/{userId:guid}/export [PluginUserData.Export]",
        ...
        "GET api/v{version:apiVersion}/plugins/search [PluginSearch.Search]",
        "GET api/v{version:apiVersion}/plugins/locations [PluginLocation.Locations]",
        "GET api/v{version:apiVersion}/plugins/locations/{locationId}/files [PluginLocation.Files]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/docs [PluginBasePath.Docs]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/license [PluginBasePath.License]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/health [PluginBasePath.Health]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/info [PluginBasePath.Info]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/permissions [PluginBasePath.Permissions]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/settings [PluginBasePath.Settings]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/_/update [PluginBasePath.Update]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/live [PluginLive.Channels]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/live/{channel}/guide [PluginLive.Guide]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/media/{ticket} [PluginMedia.Media]",
        ...
        "POST api/v{version:apiVersion}/dashboard/plugins/developer-mode [Plugin.DeveloperMode]",
        "POST api/v{version:apiVersion}/dashboard/plugins/repositories [PluginRepository.Add]",
        "POST api/v{version:apiVersion}/dashboard/plugins/runtime-mode [Plugin.RuntimeMode]",
        ...
        "POST api/v{version:apiVersion}/dashboard/plugins/offline-bundle [PluginOfflineBundle.Import]",
        "POST api/v{version:apiVersion}/dashboard/plugins/offline-mode [PluginOfflineBundle.Store]",
        "POST api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/capabilities [PluginCapability.Store]",
        "POST api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/lan-devices [PluginLanDevice.Store]",
        "POST api/v{version:apiVersion}/plugins/{id:ulid}/view [PluginUi.Submit]",
        ...
        "PUT api/v{version:apiVersion}/dashboard/plugins/telemetry [PluginTelemetry.Update]",
        "PUT api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/quotas [PluginQuota.Update]",
